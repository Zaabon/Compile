...
let of_instr b = function
  ...
  | Iimm (idr, n)   -> "Iload (" ^ Z.to_string idr ^ ") (" ^ Z.to_string n ^")"
  | Istore (idr, id)-> "Istore (" ^ Z.to_string idr ^ ") (" ^ of_id id ^")"
  | Ipushr (idr)    -> "Ipushr " ^ Z.to_string idr
  | Ipopr (idr)     -> "Ipopr " ^ Z.to_string idr
  | Iaddr (term1, term2, sum)   -> "Iaddr (" ^ Z.to_string term1 ^ ") (" ^ Z.to_string term2 ^") (" ^ Z.to_string sum ^")"
  | Iaddur (term1, term2, sum)  -> "Iaddur (" ^ Z.to_string term1 ^ ") (" ^ Z.to_string term2 ^") (" ^ Z.to_string sum ^")"
  | Isubr (term1, term2, sum)   -> "Isubr (" ^ Z.to_string term1 ^ ") (" ^ Z.to_string term2 ^") (" ^ Z.to_string sum ^")"
  | Isubur (term1, term2, sum)   -> "Isubur (" ^ Z.to_string term1 ^ ") (" ^ Z.to_string term2 ^") (" ^ Z.to_string sum ^")"
  | Ibeqr(id1, id2, ofs)        -> "Ibeqr (" ^ Z.to_string id1 ^ ") (" ^ Z.to_string id2 ^") (" ^ Z.to_string ofs ^")"
  | Ibner (id1, id2, ofs)       -> "Ibner (" ^ Z.to_string id1 ^ ") (" ^ Z.to_string id2 ^") (" ^ Z.to_string ofs ^")"
  | Ibler (id1, id2, ofs)       -> "Ibler (" ^ Z.to_string id1 ^ ") (" ^ Z.to_string id2 ^") (" ^ Z.to_string ofs ^")"
  | Ibgtr (id1, id2, ofs)       -> "Ibgtr (" ^ Z.to_string id1 ^ ") (" ^ Z.to_string id2 ^") (" ^ Z.to_string ofs ^")"
