...
let iaddf (us2: unit) : 'a Logic__Compiler_logic.hl =
  create_binop Vm__Vm.iadd

let iadduf (us2: unit) : 'a Logic__Compiler_logic.hl =
  create_binop Vm__Vm.iaddu

let isubf (us2: unit) : 'a Logic__Compiler_logic.hl =
  create_binop Vm__Vm.isub

let isubuf (us2: unit) : 'a Logic__Compiler_logic.hl =
  create_binop Vm__Vm.isubu

let inil (us2: unit) : 'a Logic__Compiler_logic.hl = []
